...
const Item = /*#__PURE__*/React__default.default.forwardRef(({
  ...
  return /*#__PURE__*/React__default.default.createElement(ItemContext.Provider, {
    ...
    className: clsx__default.default('PRIVATE_TreeView-item', className),
    ref: ref,
    tabIndex: 0,
    id: itemId,
    role: "treeitem",
...
const StyledSkeletonItemContainer = styled__default.default.span.attrs({
...
const StyledSkeletonText = styled__default.default(SkeletonText.SkeletonText).withConfig({
  displayName: "TreeView__StyledSkeletonText",
  componentId: "sc-4ex6b6-2"
})(["width:var(--tree-item-loading-width,67%);"]);
const SkeletonItem = () => {
  return /*#__PURE__*/React__default.default.createElement(StyledSkeletonItemContainer, null, /*#__PURE__*/React__default.default.createElement(SkeletonAvatar.SkeletonAvatar, {
    size: 16,
    square: true
  }), /*#__PURE__*/React__default.default.createElement(StyledSkeletonText, null));
};
