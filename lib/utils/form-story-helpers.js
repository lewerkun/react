...
const formControlArgTypesWithoutValidation = formControlArgTypeKeys.reduce((acc, key) => {
  var _formControlArgTypes$;
  if (((_formControlArgTypes$ = formControlArgTypes[key].table) === null || _formControlArgTypes$ === void 0 ? void 0 : _formControlArgTypes$.category) !== 'FormControl.Validation') {
